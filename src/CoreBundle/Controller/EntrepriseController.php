...
class EntrepriseController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entreprises = $em->getRepository('CoreBundle:Entreprise')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('CoreBundle\Form\EntrepriseType', $entreprise);
    ...
    {
        $deleteForm = $this->createDeleteForm($entreprise);
        $editForm = $this->createForm('CoreBundle\Form\EntrepriseType', $entreprise);
